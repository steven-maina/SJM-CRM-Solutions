...
class VendorInvoiceDeetailSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $invoices = DB::table('VendorInvoice_Header')->get();
        ...
        foreach ($invoices as $invoice) {
            ...
            DB::table('VendorInvoice_Details')->insert([
                'InvoiceNo' => $invoice->InvoiceNo,
                'VendorID' => $invoice->VendorID,
                'DetailDescription' => 'Main Service Delivery',
                'InvoiceReference' =>'Ref No'.$invoice->InvoiceNo,
            ...
            DB::table('VendorInvoice_Details')->insert([
                'InvoiceNo' => $invoice->InvoiceNo,
                'VendorID' => $invoice->VendorID,
                'DetailDescription' => 'Miscellaneous Service',
                'InvoiceReference' =>'Ref No'.$invoice->InvoiceNo,
