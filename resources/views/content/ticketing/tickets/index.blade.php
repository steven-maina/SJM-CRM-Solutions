...
{{--@can('ticket_create')--}}
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
          <a class="btn btn-success" href="{{ route("tickets.create") }}"><i class="fa-fw fas fa-plus nav-icon"></i>
                {{ trans('global.add') }} {{ trans('cruds.ticket.title_singular') }}
            </a>
          <a href="{{ route("categories.index") }}" class="btn btn-success" ><i class="fa-fw fas fa-tags nav-icon">
            </i>
            {{ trans('cruds.category.title') }}
          </a>
            <a href="{{ route("priorities.index") }}" class="btn btn-success"><i class="fa-fw fas fa-cogs nav-icon">
              </i>
              {{ trans('cruds.priority.title') }}
            </a>

            <a href="{{ route("statuses.index") }}"class="btn btn-success"> <i class="fa-fw fas fa-cogs nav-icon">
