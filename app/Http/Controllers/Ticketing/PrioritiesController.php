...
class PrioritiesController extends Controller
{
    public function index()
    {
        ...
        return view('content.ticketing.priorities.index', compact('priorities'));
    }
    ...
    public function create()
    {
        ...
        return view('content.ticketing.priorities.create');
    }
    ...
    public function edit(Priority $priority)
    {
        ...
        return view('content.ticketing.priorities.edit', compact('priority'));
    }
    ...
    public function show(Priority $priority)
    {
        ...
        return view('content.ticketing.priorities.show', compact('priority'));
    }
