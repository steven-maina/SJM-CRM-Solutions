...
class StatusesController extends Controller
{
    public function index()
    {
        ...
        return view('content.ticketing.statuses.index', compact('statuses'));
    }
    ...
    public function create()
    {
        ...
        return view('content.ticketing.statuses.create');
    }
    ...
    public function edit(Status $status)
    {
        ...
        return view('content.ticketing.statuses.edit', compact('status'));
    }
    ...
    public function show(Status $status)
    {
        ...
        return view('content.ticketing.statuses.show', compact('status'));
    }
